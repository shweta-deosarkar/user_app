...
class _VideoRecorderExampleState extends State<VideoRecorderExample> {
              ...
              child: SingleChildScrollView(
                  child:Column(
                      children:[
                        ...
                        RaisedButton(
                            onPressed:(){!start?_onRecordButtonPressed():_onStopButtonPressed();},
                            child: !start? Text('Start'):Text('Stop')
                        ),
                        RaisedButton(
                            onPressed:(){_onSwitchCamera();},
                            child: !front? Text('Front'):Text('Back')
                        )
  ...
  ///ii-=] Display a row of toggle to select the camera (or a message if no camera is available).
